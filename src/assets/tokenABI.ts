export const tokenABI = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "address", name: "marketingWallet", type: "address" },
          {
            ...
            name: "baseTokenForMarket",
            type: "address",
          },
          { internalType: "address", name: "mainRouter", type: "address" },
          {
            internalType: "bool",
            name: "isMarketingFeeBaseToken",
            type: "bool",
          },
          { internalType: "uint24", name: "sellLiquidityFee", type: "uint24" },
          { internalType: "uint24", name: "buyLiquidityFee", type: "uint24" },
          { internalType: "uint24", name: "sellMarketingFee", type: "uint24" },
          { internalType: "uint24", name: "buyMarketingFee", type: "uint24" },
          { internalType: "address", name: "feeContract", type: "address" },
          { internalType: "address", name: "uniswapV2Caller", type: "address" },
        ],
        internalType: "struct StandardToken.Args",
        name: "args",
        type: "tuple",
      },
      {
        internalType: "address[]",
        name: "autoApproveAddressList",
        type: "address[]",
      },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "isEx", type: "bool" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint24", name: "_sellLiquidityFee", type: "uint24" },
      { internalType: "uint24", name: "_buyLiquidityFee", type: "uint24" },
    ],
    name: "updateLiquidityFee",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_baseTokenForMarket", type: "address" },
    ],
    name: "updateMainPair",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint24", name: "_sellMarketingFee", type: "uint24" },
      { internalType: "uint24", name: "_buyMarketingFee", type: "uint24" },
    ],
    name: "updateMarketingFee",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "_isMarketingFeeBaseToken", type: "bool" },
    ],
    name: "updateMarketingWallet",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_minAmountToTakeFee", type: "uint256" },
    ],
    name: "updateMinAmountToTakeFee",
    outputs: [],
    stateMutability: "nonpayable",
